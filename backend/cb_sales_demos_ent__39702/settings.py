"""
Django settings for cb_sales_demos_ent__39702 project.
...
ROOT_URLCONF = 'cb_sales_demos_ent__39702.urls'
...
WSGI_APPLICATION = 'cb_sales_demos_ent__39702.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cb_sales_demos_ent__39702 API",
    "DESCRIPTION": "API documentation for cb_sales_demos_ent__39702 App",
    "VERSION": "v1",
}
